...
import vueWeather from '../assets/FrontEnd/vueWeather.png';
import vueSidebar from '../assets/FrontEnd/Sidebar.png';
...
const Frontendportfoliocards = () => {
    return (
        <div>
          ...
          <Portfoliocard link="https://github.com/MatthewBroyles/LandingPage" title="Meditation Landing Page" text="Meditation Web Application to help me find peace whenever I'm stressed" features="HTML, CSS, JS, API's" image={Meditation}/>
          ...
          <Portfoliocard link="https://github.com/MatthewBroyles/vue-weather" title="Weather app with Vue" text="First vue project. Simple weather application" features="HTML, CSS, JS, Vue" image={vueWeather}/>
          ...
          <Portfoliocard link="https://github.com/MatthewBroyles/sidebar" title="Vue sidebar" text="Sidebar for future projects made with vue" features="HTML, CSS, JS, Vue" image={vueSidebar}/>
        </div>
    );
}
